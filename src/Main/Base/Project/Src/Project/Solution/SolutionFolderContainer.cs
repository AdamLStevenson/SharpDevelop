...
{
	public class SolutionFolderContainer : AbstractSolutionFolder, ISolutionFolderContainer
	{
		...
		protected SolutionFolderContainer()
		{
		}

        public SolutionFolderContainer(string name, string location, string idGuid)
		{
		...
		List<IProjectSection>  sections = new List<IProjectSection>();
		
		[Browsable(false)]
		public List<IProjectSection> Sections {
			get {
				return sections;
			}
		}
		...
		[Browsable(false)]
		public virtual IProjectSection SolutionItems {
			get {
		...
		public static SolutionFolderContainer ReadFolder(TextReader sr, string title, string location, string guid)
		{
            SolutionFolderContainer newFolder = new SolutionFolderContainer(title, location, guid);
		...
		/// </summary>
		public static void ReadProjectSections(TextReader sr, ICollection<IProjectSection> sectionList)
		{
			while (true) {
