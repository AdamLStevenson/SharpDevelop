...
namespace ICSharpCode.SharpDevelop.Gui
{
	...
	public interface IWorkbench : IMementoCapable
	{
		...
		/// A collection in which all active workspace windows are saved.
		/// </summary>
        IList<IPadDescriptor> PadContentCollection
        {
			get;
		}
		...
		/// </summary>
        void ShowPad(IPadDescriptor content);
		
		/// <summary>
		/// Closes and disposes a <see cref="IPadContent"/>.
		/// </summary>
        void UnloadPad(IPadDescriptor content);
		...
		/// </summary>
		/// <example>
		/// WorkbenchSingleton.Instance.WorkbenchCreated += delegate {
		/// 	WorkbenchSingleton.Instance.Workbench.ViewOpened += ...;
		/// };
		/// </example>
