...
namespace ICSharpCode.SharpDevelop.Gui
{
	...
	public interface IViewContent : IDisposable, ICanBeDirty, IServiceProvider
	{
		...
		/// </remarks>
		void Save(IOpenedFile file, Stream stream);
		...
		/// </summary>
		bool SupportsSwitchFromThisWithoutSaveLoad(IOpenedFile file, IViewContent newView);
		
		/// <summary>
		/// Gets switching without a Save/Load cycle for <paramref name="file"/> is supported
		/// when switching from <paramref name="oldView"/> to this view content.
		/// </summary>
		bool SupportsSwitchToThisWithoutSaveLoad(IOpenedFile file, IViewContent oldView);
		
		/// <summary>
		/// Executes an action before switching from this view content to the new view content.
		/// </summary>
		void SwitchFromThisWithoutSaveLoad(IOpenedFile file, IViewContent newView);
		
		/// <summary>
		/// Executes an action before switching from the old view content to this view content.
		/// </summary>
		void SwitchToThisWithoutSaveLoad(IOpenedFile file, IViewContent oldView);
		#endregion
	}
}
